...
private int indice;
    ...
    private void jButton2MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton2MouseClicked
        // TODO add your handling code here:
        int respuesta = JOptionPane.showConfirmDialog(this, "Esta accion borara los datos actuales. ¿Estas seguro de continuar?");
        if(respuesta == 0){
            //leer los datos del archivo
            //subir al array list actual
            //el primer elemento se pondra en el formulario
            ArchivoEmpleado persistencia = new ArchivoEmpleado();
            JFileChooser jfc = new JFileChooser();
